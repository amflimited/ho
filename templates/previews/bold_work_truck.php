<?php /* Template: Bold Work Truck — Dark charcoal + amber */ ?>
<section class="fd-mock fd-mock--bwt">
  ...
  <div class="fd-mock-hero">
    ...
    <?php if ($telRaw !== ''): ?>
      <a class="fd-mock-cta" href="tel:<?= ho_h($telRaw) ?>">Get a Free Estimate</a>
      <p class="fd-mock-phone"><?= ho_h($telDisplay) ?></p>
    <?php else: ?>
      <a class="fd-mock-cta" href="#">Get a Free Estimate</a>
    <?php endif; ?>
  </div>
  ...
  <div class="fd-mock-trust">
    ...
    <span>Indiana Licensed</span>
    <span>5-Star Work</span>
  </div>
</section>
